...
internal static class Migrator
{
    ...
    public static Configuration LoadConfiguration()
    {
        ...
        var text = fileInfo.Exists ? File.ReadAllText(fileInfo.FullName) : null;
            ...
            switch (version)
            {
                ...
                default:
                    Services.PluginLog.Warning(
                        $"Tried to migrate from an unknown version: {version}"
                    );
                    goto DefaultConfiguration;
            }
        ...
        return Services.PluginInterface.GetPluginConfig() as Configuration ?? new Configuration();
    }
}
